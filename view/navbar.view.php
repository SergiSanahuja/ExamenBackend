        ...
        <li class="nav-item dropdown rounded">
          ...
          elseif($admin == 1){
            ...
            echo <<<STR
                ...
                <li><a class="dropdown-item " href="../controller/recovery-password.php"><span class="icon-key"></span> Recovery password</a></li>
                <li><a class="dropdown-item " href="../controller/llistar.php"><span class="icon-key"></span> Llistar tots els usuaris</a></li>
